...
//		System.out.println( getStart("Ninja Cats") );
		System.out.println( yourInput('k') );
	...
	public static String yourInput(char input) {
		return "Your input is: " + input;
	}
	
	
	public static String yourInput(double input) {
		return "Your input is: " + input;
	}
	
	
	
	public static String yourInput(int input) {
		return "Your input is: " + input;
	}
	
	
	
	public static String yourInput(String input) {
		return "Your input is: " + input;
	}
	...
	// get the first half of a string without using substring
 	public static String getStart(String str) {
		...
		int midpoint = str.length() / 2; // creates a midpoint
		for (int i = 0; i < midpoint; i++) { //iterates through string adding each char to return string
