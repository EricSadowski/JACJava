...
public class ArrayStuff {
	...
	public static void main(String[] args) {
		...
		int[] randInt = generateRandomInt(20, 1, 20);
		...
		System.out.println(Arrays.toString(generateRandomDouble(5, 1, 20)));
	...
	public static int[] generateRandomInt(int count, int min, int max) {
		int[] r = new int[count];
		for (int i = 0; i<r.length; i++) {
